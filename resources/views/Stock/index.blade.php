  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <span id="form_result"></span>
        ...
        <div class="form-group">
          <div class="col-md-9 col-sm-6 col-xs-12 form-group has-feedback">
              <input type="text" class="form-control has-feedback-left" id="id2" disabled>
              ...
              @endforeach
                ...
                <div class="form-group row add">
                <div class="col-md-9 col-sm-6 col-xs-12 form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" id="pre2" name="precioUnitario" placeholder="Precio" required>
                <p class="error text-center alert alert-danger hidden"></p>
               </div>
                </div>
                ...
                <div class="form-group row add">
                <div class="col-md-9" >
                <input type="text" class="form-control has-feedback-left" id="can2" name="cantidadDisponible" placeholder="Cantidad" required>
               <p class="error text-center alert alert-danger hidden"></p>
                </div>
                </div>
