...
@section ('contenido')
 <div class="row">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   <h3>Nuevo Boleta de Cera en Laminas</h3>
 ...
 <div class="row">
  ...
  <div class="table-responsive">
   <div class="panel-body">
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
     <div class="form-group">
      <label>cera en laminas</label>
      <select name="plamina_id" class="form-control selectpicker" id="plamina_id" data-live-search="true">
       @foreach($laminas as $lamina)
        <option value="{{$lamina->id}}_{{$lamina->stock}}">{{$lamina->laminas}}</option>
       @endforeach
      </select>
     </div>
    </div>
    ...
    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
     <div class="form-group">
      <label for="cantidad">Cantidad de laminas</label>
...
$(document).ready(function(){
 ...
 subtotal=[];
 $("#guardar").hide();
 $("#plamina_id").change(mostrarValores);

 function mostrarValores()
 {
   datosProducto= document.getElementById('plamina_id').value.split('_');
 ...
 function agregar(){
    ...
    lamina_id=datosProducto[0];
    laminas=$("#plamina_id option:selected").text();
    ...
    if (lamina_id!="" && stock>0 && Precio!="" && Precio>0 && cantidad!="" && descuento!="")
    {
